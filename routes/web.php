...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa']], function () {
    ...
    // Etalase
    Route::delete('etalases/destroy', 'EtalaseController@massDestroy')->name('etalases.massDestroy');
    Route::post('etalases/parse-csv-import', 'EtalaseController@parseCsvImport')->name('etalases.parseCsvImport');
    Route::post('etalases/process-csv-import', 'EtalaseController@processCsvImport')->name('etalases.processCsvImport');
    Route::resource('etalases', 'EtalaseController');
