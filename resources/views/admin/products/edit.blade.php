    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('etalase') ? 'is-invalid' : '' }}" name="etalase_id" id="etalase_id">
                    @foreach($etalases as $id => $entry)
                        <option value="{{ $id }}" {{ (old('etalase_id') ? old('etalase_id') : $product->etalase->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Product::CONDITION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('condition') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="condition_{{ $key }}" name="condition" value="{{ $key }}" {{ old('condition', $product->condition) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_product') ? 'is-invalid' : '' }}" type="text" name="video_product" id="video_product" value="{{ old('video_product', $product->video_product) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Product::STATUS_PRODUCT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status_product') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_product_{{ $key }}" name="status_product" value="{{ $key }}" {{ old('status_product', $product->status_product) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minimum_order') ? 'is-invalid' : '' }}" type="number" name="minimum_order" id="minimum_order" value="{{ old('minimum_order', $product->minimum_order) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_price') ? 'is-invalid' : '' }}" type="number" name="unit_price" id="unit_price" value="{{ old('unit_price', $product->unit_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wholesale_price') ? 'is-invalid' : '' }}" type="number" name="wholesale_price" id="wholesale_price" value="{{ old('wholesale_price', $product->wholesale_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('long') ? 'is-invalid' : '' }}" type="number" name="long" id="long" value="{{ old('long', $product->long) }}" step="0.01">
                @if($errors->has('long'))
                    <div class="invalid-feedback">
                        {{ $errors->first('long') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('width') ? 'is-invalid' : '' }}" type="number" name="width" id="width" value="{{ old('width', $product->width) }}" step="0.01">
                @if($errors->has('width'))
                    <div class="invalid-feedback">
                        {{ $errors->first('width') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $product->height) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Product::INSURANCE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('insurance') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="insurance_{{ $key }}" name="insurance" value="{{ $key }}" {{ old('insurance', $product->insurance) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('pre_order') ? 'is-invalid' : '' }}" name="pre_order" id="pre_order">
                    ...
                    @foreach(App\Models\Product::PRE_ORDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('pre_order', $product->pre_order) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
